 ...
 *  Version: 0.22.121
 */
import { propertyChange, ExecuteRule, Initialize, RemoveItem, Change, FormLoad, FieldChanged, ValidationComplete, Valid, Invalid, SubmitSuccess, CustomEvent, SubmitError, SubmitFailure, Submit, Save, Reset, Focus, RemoveInstance, AddInstance, AddItem, Click, ImportData } from './afb-events.js';
...
class Form extends Container {
    ...
    importData(dataModel) {
        ...
        //this.dispatch(new ImportData(dataModel, true));
    }
